 ...
 * 新建一个房间
 */
$response = $proxy->newGame(['uid' => $_SESSION['uid']]);
...
<div class="container">
    <div class="row">
        ...
        <h2 class="clo-md-12">Welcome!Gamer: <?php echo $_SESSION['uid']; ?>
		  Game ID: <?php echo $game_id; ?>
		</h2>
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if (json.status !== 1) {
                    ...
                    //顺利落子，黑子
                    $('#' + x + y).html('<span style="color:#000">●</span>');
                }
            },
            error: function(json) {
